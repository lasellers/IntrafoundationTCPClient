// test_harness_ftp.cpp : Defines the entry point for the console application.
//
...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	*/
	...
	//    char* const szhost="192.168.1.199"; //Sarah
	//    char* const szhost="192.168.1.200"; //Horace
	//char* const szhost="192.168.1.68"; //Cynthia
	...
	//
	{
		...
		case '0':
			filebytes=512;
			strcpy(filename,"512.csv");
			strcpy(sfilename,"c:\\InetPub\\wwwroot\\IntrafoundationTCPClient\\test_data\\512.send.csv");
			strcpy(rfilename,"c:\\InetPub\\wwwroot\\IntrafoundationTCPClient\\test_data\\512.recv.csv");
			break;
		case '1':
			filebytes=1000000;
			strcpy(filename,"1mb.csv");
			strcpy(sfilename,"c:\\InetPub\\wwwroot\\IntrafoundationTCPClient\\test_data\\send\\1mb.csv");
			strcpy(rfilename,"c:\\InetPub\\wwwroot\\IntrafoundationTCPClient\\test_data\\recv\\1mb.csv");
			break;
		case '2':
			filebytes=10000000;
			strcpy(filename,"10mb.csv");
			strcpy(sfilename,"c:\\InetPub\\wwwroot\\IntrafoundationTCPClient\\test_data\\send\\10mb.csv");
			strcpy(rfilename,"c:\\InetPub\\wwwroot\\IntrafoundationTCPClient\\test_data\\recv\\10mb.csv");
			break;
		case '3':
			filebytes=30000000;
			strcpy(filename,"30mb.csv");
			strcpy(sfilename,"c:\\InetPub\\wwwroot\\IntrafoundationTCPClient\\test_data\\send\\30mb.csv");
			strcpy(rfilename,"c:\\InetPub\\wwwroot\\IntrafoundationTCPClient\\test_data\\recv\\30mb.csv");
			break;
		case '7':
			filebytes=700000000;
			strcpy(filename,"700mb.csv");
			strcpy(sfilename,"c:\\InetPub\\wwwroot\\IntrafoundationTCPClient\\test_data\\send\\700mb.csv");
			strcpy(rfilename,"c:\\InetPub\\wwwroot\\IntrafoundationTCPClient\\test_data\\recv\\700mb.csv");
			break;
		case '4':
			filebytes=4000000000;
			strcpy(filename,"4gb.csv");
			strcpy(sfilename,"c:\\InetPub\\wwwroot\\IntrafoundationTCPClient\\test_data\\send\\4gb.csv");
			strcpy(rfilename,"c:\\InetPub\\wwwroot\\IntrafoundationTCPClient\\test_data\\recv\\4gb.csv");
			break;
		default:
			filebytes=10000000;
			strcpy(filename,"10mb.csv");
	...
	if(c=='Y' || c=='y')
	{
		...
		if(h!=NULL)
		{
			...
			const size_t mb=1000000/78; //12820
			...
			size_t numwrite=fwrite(finalline,1,strlen(finalline),h);
			testfilesize+=numwrite;
			fclose(h);
		}
