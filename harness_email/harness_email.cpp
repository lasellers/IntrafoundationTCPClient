// harness_email.cpp : Defines the entry point for the console application.
//
...
main()
{
    ...
    const char *rfilename="c:\\InetPub\\wwwroot.current\\tcpclient2\\send\\tcpclient.png";
    const char *wfilename="c:\\InetPub\\wwwroot.current\\tcpclient2\\recv\\uu.png";
    ...
    if(c=='m' || c=='M')
    {
        ...
        if(w)
        {
            ...
            w->SendCRLF("MAIL FROM: tcpclient@intrafoundation.com");
            w->RecvCRLF(r);
            
            w->SendCRLF("RCPT TO: tcpclient@intrafoundation.com");
            w->RecvCRLF(r);
            ...
            w->SendCRLF("X-Sender: tcpclient@intrafoundation.com");
    ...
    else if(c=='u' || c=='U')
    {
        ...
        if(w)
        {
            ...
            sendlength=w->SendCRLF("MAIL FROM: tcpclient@intrafoundation.com");
            recvlength=w->RecvCRLF(r);
			
            sendlength=w->SendCRLF("RCPT TO: tcpclient@intrafoundation.com");
            recvlength=w->RecvCRLF(r);
			...
			if(buf)
			{
				...
				*(buf+buf_length)=0;
				...
				if(buf_length)
				{
					...
					FILE *h=fopen("W:\\InetPub\\wwwroot.current\\tcpclient2\\recv\\base64.png","wb");
					if(h)
					{
...
// /nologo /MLd /W3 /Gm /GX /ZI /Od /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /D "_MBCS" /Fp"Debug/harness_http.pch" /Yu"stdafx.h" 

// /nologo /MLd /W3 /Gm /GX /ZI /Od /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /D "_MBCS" /Fo"Debug/" /Fd"Debug/" /FD /GZ /c 

// /nologo /MLd /W3 /Gm /GX /ZI /Od /D "WIN32" /D "_DEBUG" /D "_CONSOLE" /D "_MBCS" /Fp"Debug/harness_email.pch" /Yu"stdafx.h" 